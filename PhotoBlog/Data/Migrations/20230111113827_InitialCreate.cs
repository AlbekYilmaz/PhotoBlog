    ...
    public partial class InitialCreate : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, new DateTime(2023, 1, 11, 14, 38, 27, 412, DateTimeKind.Local).AddTicks(568), "As the sun sets behind the hills, I watch the unique blue of the sea. ", "sample.jpg", "Mountains and Sea" });
        }
